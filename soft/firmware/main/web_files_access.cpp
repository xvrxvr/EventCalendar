...
{
    extern const unsigned char web_actions_txt_start[] asm("_binary_web_actions_txt_start");
    extern const unsigned char web_actions_txt_end[] asm("_binary_web_actions_txt_end");
    ...
    switch(key[0])
    {
        case 'a':
            switch(key[1])
            {
                case 'c': return strcmp(key+2, "tions.txt") == 0 ? CDNDef{web_actions_txt_start, web_actions_txt_end} : CDNDef{};
                case 'd':
                    switch(key[2])
                    {
